...
class SimSPPF(nn.Module):
    def __init__(self, c1, c2=None, k=5): 
        ...
        # Explicitly hardcode your optimized ReLU activation
...
class GhostConv(nn.Module):
    """Ghost Convolution — half FLOPs vs standard Conv, same output shape."""
    def __init__(self, c1, c2, k=3, s=1, act=True):
        super().__init__()
        c_ = c2 // 2
        self.primary = Conv(c1, c_, k, s,      act=act)
        self.cheap   = Conv(c_, c_, 3,  1, g=c_, act=act)  # depthwise
